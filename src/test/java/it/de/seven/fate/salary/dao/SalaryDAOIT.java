package it.de.seven.fate.salary.dao;
...
public class SalaryDAOIT {

    @Inject
    SalaryDAO sut;

    @Inject
    SalaryBuilder builder;
    ...
    public void getByModel() throws Exception {
        Salary model = CollectionUtil.random(models);
        assertEquals(model, sut.get(model));
    }
    ...
    public void list() throws Exception {
        List<Salary> entities = sut.list();
        assertEquals(models.size(), entities.size());
    }

    @Test
    public void pagination() throws Exception {
        List<Salary> entities = sut.list(0, models.size());
        assertEquals(models.size(), entities.size());
    }
